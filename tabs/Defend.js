...
Tabs.Defend = {
	...
	init: function (div) {
		...
		if (!SelectiveDefending) {
			...
			m +='<div align=center><table class=xtab width=700px><tr><td><SELECT class="btSelector" style="width:190px;" id="DAAPresetSel" onchange="DAASelectPreset(this);"></select>&nbsp;<a id="DAADeletePreset" class="inlineButton btButton brown8 disabled" onclick="DAADelPreset()"><span>'+uW.g_js_strings.commonstr.deletetx+'</span></a></td><td align=right>';
			m +=tx('New Name')+':&nbsp;<INPUT class=btInput id=DAAPresetName type=text style="width:190px;" maxlength=20 value=""\>&nbsp;<a id="DAASavePreset" class="inlineButton btButton brown8" onclick="DAASavePreset()"><span>'+tx('Save')+'</span></a></td></tr></table>';
